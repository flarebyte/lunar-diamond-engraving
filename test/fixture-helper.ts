...
const contactLogger: EngravingLoggerFunction = async (_options: EngravingLoggerOpts) => {};
...
const contactWorkFail: EngravingActionFunction = async (mask: EngravingMask) => {
...
export const createFixtureChisel = ({
	...
	modelId: 'contact';
	triggerFail: Array< | 'validation-payload'
	| 'contact-address'
	| 'shield-parameters'
	| 'shield-context'
	| 'on-finish-ready'>;
